...
static void MX_DSIHOST_DSI_Init(void)
{
  ...
  PhyTimings.ClockLaneHS2LPTime = 22;
  PhyTimings.ClockLaneLP2HSTime = 22;
...
static void MX_MDMA_Init(void)
{
  ...
  HAL_NVIC_SetPriority(MDMA_IRQn, 15, 0);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLE_DWAKE_GPIO_Port, BLE_DWAKE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : D7_Pin WIFI_ON_Pin */
  GPIO_InitStruct.Pin = D7_Pin|WIFI_ON_Pin;
  ...
  /*Configure GPIO pin : BOOT_IN_Pin */
  GPIO_InitStruct.Pin = BOOT_IN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BOOT_IN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : WIFI_HWAKE_Pin */
  GPIO_InitStruct.Pin = WIFI_HWAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(WIFI_HWAKE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : RGB_GREEN_Pin D4_Pin */
  GPIO_InitStruct.Pin = RGB_GREEN_Pin|D4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : BLE_HWAKE_Pin */
  GPIO_InitStruct.Pin = BLE_HWAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BLE_HWAKE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CAMERA_XCLK_Pin */
  ...
  /*Configure GPIO pin : BLE_DWAKE_Pin */
  GPIO_InitStruct.Pin = BLE_DWAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BLE_DWAKE_GPIO_Port, &GPIO_InitStruct);
